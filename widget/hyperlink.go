...
func (hl *Hyperlink) focusWidth() float32 {
	...
	return fyne.Min(hl.size.Width, hl.textSize.Width+innerPad*2) - innerPad
}
...
func (hl *Hyperlink) isPosOverText(pos fyne.Position) bool {
	...
	return pos.X >= xpos && pos.X <= xpos+hl.focusWidth() &&
		pos.Y >= innerPad/2 && pos.Y <= hl.textSize.Height*lineCount+innerPad+innerPad/2
}
...
func (r *hyperlinkRenderer) Layout(s fyne.Size) {
	...
	r.under.Move(fyne.NewPos(xposUnderline, r.hl.textSize.Height*lineCount+theme.InnerPadding()))
